...
@LargeTest
// ! This could not be run because of compilation errors in Emulator and real devices
class TasksActivityTest {
    ...
    @Test
    // runBlockingTest can be used in latest kotlin lib version
    fun editTask() = runBlocking {
        // Set initial state.
        repository.saveTask(Task("TITLE1", "DESCRIPTION"))

        // Start up Tasks screen.
        // You must set the initial state of the data layer before it
    ...
    fun createOneTask_deleteTask() = runBlocking {
        ...
        onView(withId(R.id.add_task_title_edit_text)).perform(replaceText("task"))
